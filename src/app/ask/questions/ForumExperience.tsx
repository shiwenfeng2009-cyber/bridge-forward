...
const seed: Question[] = [
  ...
  {id:"english",title:"How can I improve my English speaking?",zh:"我怎样提高英语口语？",body:"I understand more than I can say. What are some low-pressure ways to practice at school?",category:"English & Communication",answers:5,time:"5h ago",badge:"Peer Mentor",answered:true},
  {id:"clubs",title:"Where can I find clubs that match my interests?",zh:"我在哪里可以找到适合自己的社团？",body:"I’m new and don’t know anyone yet. Is there a club list or someone who can introduce me?",category:"School Life",answers:4,time:"Yesterday",badge:"Student Answer",answered:true},
  {id:"friends",title:"I feel shy and it’s hard to make friends. Any tips?",zh:"我很害羞，交朋友很难，有什么建议吗？",body:"Lunch and group work feel awkward. How did other new students start talking to people?",category:"Friends & Belonging",answers:7,time:"1d ago",badge:"Counselor Verified",answered:true},
  {id:"grade-drop",title:"What happens if my grade drops?",zh:"如果成绩下滑，我该怎么办？",body:"I’m worried about one class. When should I speak with my teacher or counselor?",category:"Classes & Grades",answers:6,time:"1d ago",badge:"Student Answer",answered:true},
  {id:"college",title:"How do I start college applications?",zh:"我该如何开始大学申请？",body:"What should I prepare first, and when should I meet the college and career counselor?",category:"College & Future",answers:8,time:"2d ago",badge:"Peer Mentor",answered:true},
];
const starterReplies: Record<string,Reply[]> = {
  graduate:[{id:"g1",author:"Mia",role:"Student",text:"先看自己的 transcript 和已获得的 credits，然后预约 counselor 一起核对毕业要求。",time:"1h ago"},{id:"g2",author:"Peer Mentor",role:"同伴导师",text:"You can also bring a list of the classes you are taking now. The counselor can help you make a semester-by-semester plan.",time:"45m ago"},{id:"g3",author:"Counselor",role:"辅导员确认",text:"Official graduation progress should always be confirmed with your assigned counselor.",time:"20m ago"}],
  english:[{id:"e1",author:"Lina",role:"Student",text:"我先从社团和同桌的一对一聊天开始，比在全班发言压力小很多。",time:"4h ago"},{id:"e2",author:"Peer Mentor",role:"同伴导师",text:"Try one small goal each day: ask one question, greet one classmate, or practice a sentence before class.",time:"3h ago"}],
  clubs:[{id:"c1",author:"Kai",role:"Student",text:"The activities office and the club directory are good places to start. Club Fair is especially helpful.",time:"Yesterday"},{id:"c2",author:"Yuki",role:"Student",text:"可以先选一个真正感兴趣的社团，第一次带朋友一起去也可以。",time:"Yesterday"}],
  friends:[{id:"f1",author:"Anonymous Student",role:"Student",text:"I started by sitting near the same people at lunch and saying hi every day. It became easier slowly.",time:"22h ago"},{id:"f2",author:"Counselor",role:"辅导员确认",text:"如果孤独感持续影响上学或睡眠，请来 counselor office，我们可以一起找支持。",time:"18h ago"}],
  "grade-drop":[{id:"d1",author:"Noah",role:"Student",text:"先看老师在成绩系统里的 comments，再把不懂的作业和问题写下来，office hours 会更有效率。",time:"20h ago"},{id:"d2",author:"Peer Mentor",role:"同伴导师",text:"One low grade does not define you. Ask early about corrections, tutoring, and a realistic catch-up plan.",time:"17h ago"},{id:"d3",author:"Counselor",role:"辅导员确认",text:"If several classes are becoming difficult at once, make an appointment so we can review workload and support options together.",time:"12h ago"}],
  college:[{id:"p1",author:"Avery",role:"Senior Student",text:"I started with a college list, activity record, and deadlines spreadsheet before writing essays.",time:"2d ago"},{id:"p2",author:"College & Career Counselor",role:"升学指导",text:"请先预约一次规划会谈。我们会根据年级、目标和家庭情况制定适合你的申请时间线。",time:"1d ago"}],
};
const categories=["Classes & Grades","Friends & Belonging","English & Communication","School Life","College & Future","Other"];
const initialFeed: FeedMessage[] = [
  {id:"m1",author:"Anonymous Student",role:"New question · 新问题",text:"I’m still learning how credits and graduation requirements work. Who should I ask to review my progress?",time:"2:20 PM",category:"Classes & Grades"},
  {id:"m2",author:"Mia",role:"Student",text:"先看自己的 transcript 和已获得的 credits，然后预约 counselor 一起核对毕业要求。",time:"2:23 PM",category:"Classes & Grades",replyTo:"回复 Anonymous Student"},
  {id:"m3",author:"Peer Mentor",role:"同伴导师",text:"Bring your current class list too. A counselor can help make a semester-by-semester plan.",time:"2:25 PM",category:"Classes & Grades",replyTo:"回复毕业进度问题"},
  {id:"m4",author:"Lina",role:"New question · 新问题",text:"我很想练习英语口语，但在全班面前说话会紧张。大家是怎么开始的？",time:"2:31 PM",category:"English & Communication"},
  {id:"m5",author:"Kai",role:"Student",text:"我从一对一聊天和参加社团开始，每天只给自己一个很小的目标。",time:"2:34 PM",category:"English & Communication",replyTo:"回复 Lina"},
  {id:"m6",author:"Anonymous Student",role:"New question · 新问题",text:"Does anyone know a club that is friendly to students who just arrived?",time:"2:40 PM",category:"School Life"},
  {id:"m7",author:"Yuki",role:"Student",text:"Club Fair 很适合先逛一圈。你也可以告诉我喜欢什么，我帮你一起找。",time:"2:42 PM",category:"School Life",replyTo:"回复社团问题"},
  {id:"m8",author:"Counselor",role:"辅导员",text:"提醒大家：正式的毕业要求和课程安排，请最后向 assigned counselor 确认。",time:"2:46 PM",category:"Classes & Grades"},
];
const feedTranslations: Record<string,string> = {
  m1:"我还在了解学分和毕业要求。应该请谁帮我检查毕业进度？", m2:"Check your transcript and earned credits first, then make an appointment with your counselor.",
  m3:"也请带上你现在的课程清单。辅导员可以帮你制定逐学期计划。", m4:"I want to practice spoken English, but speaking in front of the class makes me nervous. How did everyone start?",
  m5:"I started with one-on-one conversations and clubs, giving myself one small goal every day.", m6:"有人知道哪些社团对刚到学校的学生比较友好吗？",
